...
// 列表（需登录）
router.get('/', verifyJwt, asyncHandler(async (req: AuthedRequest, res) => {
...
router.post('/', verifyJwt, requireAdmin, asyncHandler(async (req: AuthedRequest, res) => {
...
router.put('/:id', verifyJwt, requireAdmin, asyncHandler(async (req: AuthedRequest, res) => {
...
router.delete('/:id', verifyJwt, requireAdmin, asyncHandler(async (req: AuthedRequest, res) => {
  const id = Number(req.params.id)
