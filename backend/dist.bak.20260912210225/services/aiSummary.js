...
async function getConversationText(conversationId, maxChars = 12000) {
 ...
 */
export async function generateSummary(conversationId, userId) {
 ...
 * upsert：同一对话重复生成会覆盖。
 */
export async function saveSummary(conversationId, userId, result, model) {
