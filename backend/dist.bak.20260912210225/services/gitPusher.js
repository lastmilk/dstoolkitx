...
export async function ensureBareRepo(repoFsName) {
...
export async function pushSplitTree(opts) {
    ...
    try {
        ...
        await git(['commit', '-m', commitMessage, `--author=${gitUsername} <${gitUsername}@git.dstoolkit.local>`], { cwd: workDir });
...
/** 列出仓库内所有文件（path → 内容） */
export async function listRepoTree(repoFsName) {
...
//# sourceMappingURL=gitPusher.js.map