...
import { detectSharePlatform, extractConvIdFromShareUrl, fetchShareConversation, parseUnifiedMessageJson, sourceToEnum, } from '../services/importService.js';
import { createUnifiedConversation, listUserConversations, } from '../services/unifiedConversationService.js';
const router = Router();
...
router.post('/json', upload.single('file'), asyncHandler(async (req, res) => {
    ...
    const source = format === 'deepseek' ? 'DEEPSEEK_JSON' : 'OPENAI_JSON';
