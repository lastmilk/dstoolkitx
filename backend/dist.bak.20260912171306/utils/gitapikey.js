...
export function needsGitUsername(username) {
    return /[^\x00-\x7F]/.test(username);
}
/** 生成 Git API Key：dstkg_ + 32 字节 base62（不可猜测） */
export function generateGitApiKey() {
...
export function hashGitApiKey(key) {
    return crypto.createHash('sha256').update(key).digest('hex');
}
/** 掩码展示：dstkg_abcd****wxyz */
export function maskGitApiKey(key) {
    if (!key)
        return '';
    if (key.length <= 14)
        return '****';
...
//# sourceMappingURL=gitapikey.js.map