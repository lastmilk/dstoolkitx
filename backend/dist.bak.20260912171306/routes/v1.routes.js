...
router.get('/configs/:id/conversations', asyncHandler(async (req, res) => {
...
router.get('/configs/:id/conversations/:convId', asyncHandler(async (req, res) => {
...
router.get('/search', asyncHandler(async (req, res) => {
    ...
    const convWhere = { config: { userId: req.user.id } };
    if (configId)
