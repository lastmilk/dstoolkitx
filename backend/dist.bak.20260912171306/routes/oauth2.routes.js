...
router.post('/authorize', verifyJwt, asyncHandler(async (req, res) => {
...
async function issueTokens(userId, clientId, clientName, scopes) {
...
router.get('/clients', verifyJwt, asyncHandler(async (req, res) => {
...
router.post('/clients', verifyJwt, asyncHandler(async (req, res) => {
...
router.delete('/clients/:id', verifyJwt, asyncHandler(async (req, res) => {
